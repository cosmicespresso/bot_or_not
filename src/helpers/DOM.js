export const handleResize = (e) => {
  ...
  // the last calculation is the 10px margin for the header and the input as well as the 2px solid line on very top and bottom
  let dialogWidth = header.offsetWidth;
  let dialogHeight = y - header.offsetHeight - input.offsetHeight - 4*10 - 4; 
