	...
	return (
		<div className={props.aboutClass} style={{height: `${props.dialogHeight}px`}}>
			<div className='text' style={{fontSize: `${props.fontSize}px`}}>
				...
				<h4>CURIOUS ABOUT BOTS?</h4>
				
				<p>The game you just played is a kind of "Turing test", named after the pioneering computer scientist, Alan Turing, who wanted to understand if a machine could convince someone that it was actually human.</p> 			
				...
				<h4>DISCLAIMER</h4>
				<p><emph>This particular</emph> bot not record your conversation or store any information about you. However, this website does use Google Analytics to identify the kind of device you visited with, and where you accessed it from.</p>
			</div>
		</div>
	);
}
