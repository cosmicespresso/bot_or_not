...
export const stateMap = [
  {
    ...
    main: 'Narrator',
    headerText: 'A Truth or Dare Turing Test',
    fieldTop: 'Bot or Not is a truth game between you, and either another human or a bot...',
    fieldBottom: '',
    input: 'SingleButton',
    singleButtonText: 'Next',
    button1Text: '',
  ...
  },
{
    ...
    main: 'Narrator',
    headerText: 'A Truth or Dare Turing Test',
    fieldTop: '...it is played in rounds of 60 seconds',
    fieldBottom: '',
    input: 'SingleButton',
  ...
  },
{
    ...
    main: 'Narrator',
    headerText: 'A Truth or Dare Turing Test',
    fieldTop: "It works like truth or dare, with just the 'truth' part...",
    fieldBottom: '',
    input: 'SingleButton',
    singleButtonText: 'Hold on a sec ✋',
    button1Text: '',
  ...
  },
{
    ...
    main: 'Narrator',
    headerText: 'A Truth or Dare Turing Test',
    fieldTop: "...you and your opponent take it in turns to ask each other questions.",
    fieldBottom: '',
    input: 'SingleButton',
    singleButtonText: 'Hold on a sec ✋',
    button1Text: '',
  ...
  },
{
    ...
    main: 'Narrator',
    headerText: 'A Truth or Dare Turing Test',
    fieldTop: 'After three rounds, you will each be asked to judge whether they are a human or bot...',
    fieldBottom: '',
    input: 'SingleButton',
    singleButtonText: 'Hold on a sec ✋',
    button1Text: '',
