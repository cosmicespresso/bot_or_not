  ...
  },
{
    ...
    main: 'Narrator',
    headerText: 'Bot or Not?',
    fieldTop: "(it's essentially the 'Truth' part of 'Truth or Dare')",
    fieldBottom: '',
    input: 'SingleButton',
    singleButtonText: 'Next',
    button1Text: '',
  ...
  },
{
    ...
    main: 'Narrator',
    headerText: 'Bot or Not?',
    fieldTop: "Your opponent and you take turns to ask questions.",
    fieldBottom: '',
    input: 'SingleButton',
    singleButtonText: 'Next',
    button1Text: '',
  ...
  },
{
  ...
  },
  {
    ...
    main: 'NarratorWait',
    headerText: '',
    fieldTop: 'is thinking of a truth challenge for you  💬',
    fieldBottom: '',
    input: 'SingleButton',
    ...
    main: 'Narrator',
    headerText: '',
    fieldTop: 'Now it’s your turn to think of a truth challenge ⚖️',
    fieldBottom: '',
    input: 'SingleButton',
    ...
    main: 'NarratorWait',
    headerText: '',
    fieldTop: 'is coming up with the last challenge for you  💬',
    fieldBottom: '',
    input: 'SingleButton',
    singleButtonText: 'Give them a sec ✋',
    button1Text: '',
    ...
    fieldBottom: '',
    input: 'SingleButton',
    singleButtonText: 'Credits + Chat more',
    button1Text: '',
    button2Text: '',
  },{
    step: 27, 
